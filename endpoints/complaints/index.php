...
function viewDepartment($conn)
{
    ...
    if($result->num_rows==0){
        ...
        $outp = array();
        $outpC = array('code' => 200, 'state' => 'success', 'message' => 'Complaints are available');
...
{
    $arr = array('code' => 200, 'state' => 'success', 'message' => 'Shows the available endpoints.','action'=>'create/view/delete','name'=>'Place name here','description'=>'Place description here', 'example1'=>'/complaints/?action=view');
    header('Content-type: application/json');
    echo json_encode($arr);
}